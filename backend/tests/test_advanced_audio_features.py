...
class TestAdvancedAudioFeatures:
    ...
    def test_advanced_silence_trimming_dynamic(
        ...
        assert len(trimmed_audio) < len(
            audio_data
        )  # Should be shorter due to silence removal
        ...
        assert (
            trimming_info["silence_percentage"] > 0
        )  # Should have removed some silence
    ...
    def test_advanced_silence_trimming_segment(
        self, audio_processor, sample_audio_data
    ):
    ...
    def test_advanced_silence_trimming_adaptive(
        self, audio_processor, sample_audio_data
    ):
