...
class TestQRCodeExpiration:
    ...
    def test_qr_url_paid_version_5_years(self, mock_file_uploader_class, pdf_generator, mock_paid_order):
    ...
    @patch('backend.services.pdf_generator.FileUploader')
    def test_qr_url_preview_version_7_days(self, mock_file_uploader_class, pdf_generator, mock_session):
    ...
    @patch('backend.services.pdf_generator.FileUploader')
    def test_qr_url_missing_file_error(self, mock_file_uploader_class, pdf_generator, mock_paid_order):
    ...
    def test_visual_qr_url_paid_version_5_years(self, mock_file_uploader_class, visual_generator, mock_paid_order):
    ...
    @patch('backend.services.visual_pdf_generator.FileUploader')
    def test_visual_qr_url_preview_version_7_days(self, mock_file_uploader_class, visual_generator, mock_session):
